...
| 港股窝轮、牛熊证、衍生品行情 | `quote_derivatives_hk` | HK | 美股期权、A股、日股 |
| 美股期权链、期权报价、Greeks、到期日 | `quote_us_options` | US | 港股窝轮、A股、日股 |
...
| 筹码成本、获利比例 | `market_position_cost` | HK、US | A股/日股未覆盖，不要强行调用 |
...
- **A股**：数字。`1` 第一季度、`6` 中期、`9` 前三季度、`12` 年度、`99` 非常规报表。
