...
description: "FIU Finance MCP assistant. Use when the user asks about Hong Kong, US, A-share(Zhcall), Japan or global bond market data — quotes, order book, K-line, financial statements, shareholding, capital flow, rankings, ETF and fund data, IPO, US options, news or reference codes."
user-invocable: true
...
Market data for Hong Kong, US, A-share(Zhcall), Japan and global fixed income: quotes, order book, tick trades, K-line, market rankings, capital flow, F10 fundamentals, shareholding, ETF and fund data, IPO, US options, news and reference codes.
...
4. **Markets.** `CN` is the A-share(Zhcall) market. `GLOBAL` is cross-market data, currently fixed income — do not use it for ordinary equities.
