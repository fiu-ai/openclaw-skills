...
| F10数据 | ✅ | ✅ | ✅ |
| 交易功能 | ✅ | ⚠️ (请用discover查询) | ✅ |
| 代码搜索 | ✅ (toolkit) | ✅ (toolkit) | ✅ (toolkit) |

**注意**: 
- 美股市场: 使用 `/fiu-market-assistant discover us_sdk` 查看可用工具
- 美股交易: 使用 `/fiu-market-assistant discover us_sdk` 查看可用交易工具
